		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Model",
									"targetURL": "#comapplexusproject3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexusproject3-display": {
								"semanticObject": "comapplexusproject3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.project3",
									"url": sap.ui.require.toUrl("com/applexus/project3")
								}
							}
						}
					}
