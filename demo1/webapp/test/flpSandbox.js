		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App1",
									"targetURL": "#comapplexusdemo1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexusdemo1-display": {
								"semanticObject": "comapplexusdemo1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.demo1",
									"url": sap.ui.require.toUrl("com/applexus/demo1")
								}
							}
						}
					}
